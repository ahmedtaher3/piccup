...
class EnterTimeAdapter(
    private val context: Context,
    private var myData: ArrayList<String>,
    private val listener: OnEnterTimeSelect
) : RecyclerView.Adapter<EnterTimeAdapter.ViewHolder>() {
    ...
    interface OnEnterTimeSelect {

        fun setOnEnterTimeSelect(model: String)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            listener.setOnEnterTimeSelect(model)
