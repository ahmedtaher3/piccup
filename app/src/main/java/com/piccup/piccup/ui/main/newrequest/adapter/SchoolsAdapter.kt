...
class SchoolsAdapter(
    ...
    private var myData: ArrayList<GetSchoolsQuery.School?>,
    private val listener: OnSchoolSelect
    ...
    interface OnSchoolSelect {
        fun setOnSchoolSelect(model: GetSchoolsQuery.School?)
    }

    fun setMyData(myData: ArrayList<GetSchoolsQuery.School?>) {
        this.myData = myData
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            listener.setOnSchoolSelect(model)
        }
