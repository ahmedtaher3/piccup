...
class ExitTimeAdapter(
    private val context: Context,
    private var myData: ArrayList<String>,
    private val listener: OnExitTimeSelect
) : RecyclerView.Adapter<ExitTimeAdapter.ViewHolder>() {
    ...
    interface OnExitTimeSelect {

        fun setOnExitTimeSelect(model: String)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            listener.setOnExitTimeSelect(model)
